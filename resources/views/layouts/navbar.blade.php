...
<div class="d-flex align-items-stretch" id="kt_header_nav">
    ...
    <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
        ...
        <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
            ...
            <div class="menu-item  menu-lg-down-accordion me-lg-1 {{ request()->is('/home') ? 'show here' : '' }}">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                    @foreach(App\Models\Category::where(['status' => 'active', 'main_category_id' => $main_category->id])->limit(3)->get() as $category)
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                    @foreach(App\Models\Year::limit(5)->get() as $year)
                    
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        class="menu-item menu-lg-down-accordion">
                        <a href="{{ route('job-solution.year', $year->year) }}">
                        <span class="menu-link py-3">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                <span class="svg-icon svg-icon-2">
                            ...
                            <span class="menu-title">{{$year->year}}</span>
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                        class="menu-item menu-lg-down-accordion">
                        <a href="{{ route('job-solution.year', 'all') }}">
                        <span class="menu-link py-3">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                <span class="svg-icon svg-icon-2">

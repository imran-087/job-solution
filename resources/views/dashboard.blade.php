    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">User Summary</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
            ...
            <div class="col-12">
                ...
                <div class="card card-xl-stretch">
                    ...
                    <div class="card-header border-0 bg-danger py-5">
                        <h3 class="card-title fw-bolder text-white">JOB SOLUTION</h3>
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0 d-flex justify-content-center">
                                ...
                                <div class="col-3 bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-primary fw-bold fs-6">Data goes here</a>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->

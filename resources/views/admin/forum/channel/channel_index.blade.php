    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Channel</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Channel Management</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Channel list</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                        ...
                        <!--begin::Add product-->
                        <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()">Add Channel</a>
                        <!--end::Add product-->
                    </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class=" min-w-200px">Channel Name</th>
...
<div class="modal fade" id="kk_modal_new_channel" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kk_modal_new_channel_form" class="form" enctype="multipart/form-data">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Add New Channel</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#dataTable').DataTable({
                ...
                responsive: true,
                serverSide: true,
                ajax: "{{ url('admin/forum/channel/index') }}",
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        function addNew(){
            ...
            $('.with-errors').text('')
            $('#kk_modal_new_channel_form')[0].reset();
            $('#kk_modal_new_channel').modal('show')
        }
        ...
        function edit(id){
            $.ajax({
                type:"GET",
                url: "{{ url('admin/forum/channel/get')}}"+'/'+id,
                dataType: 'json',
                success:function(data){
                   $('input[name="channel_id"]').val(data.id)
        ...
        $('#kk_modal_new_service_cancel').on('click', function(){
            $('#kk_modal_new_channel_form')[0].reset();
            $("#kk_modal_new_channel").modal('hide');
        })

        //new category save
        $('#kk_modal_new_channel_form').on('submit',function(e){
            e.preventDefault()
            $('.with-errors').text('')
            ...
            $.ajax({
                type:"POST",
                url: "{{ url('admin/forum/channel/store')}}",
                data:formData,
                cache:false,
                contentType: false,
                processData: false,
                success:function(data){
                    if(data.success ==  false || data.success ==  "false"){
                        ...
                        $('#kk_modal_new_channel_form').find('.messages').html(alertBox).show();
                    }else{
                        // empty the form
                        $('#kk_modal_new_channel_form')[0].reset();
                        $("#kk_modal_new_channel").modal('hide');
    ...
    function deleteChannel(id){
        Swal.fire({
            ...
            if(o.value){ //if agree
                $.ajax({
                    type: "GET",
                    url: "{{ url('admin/forum/channel/delete') }}"+'/'+id,
                    data: {},

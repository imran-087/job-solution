        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Trashed Description list </li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#dataTable').DataTable({
                ...
                responsive: true,
                serverSide: true,
                ajax: "{{ url('admin/trashed/description-trashed') }}",
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
            ...
            $('.kk-datatable-filter').on('change',function(){
                ...
                table.ajax.url( "{{ url('admin/trashed/description-trashed?status=') }}"+this.value ).load();
            })
        ...
        function restore(id){
            Swal.fire({
                ...
                if(o.value){ //if agree
                    $.ajax({
                        type: "GET",
                        url: "{{ url('admin/trashed/restore-description') }}"+'/'+id,
                        data: {},

            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                        ...
                        <!--begin::Add product-->
                        <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()">Add Role</a>
                        <!--end::Add product-->
                    </div>
...
<div class="modal fade" id="kk_modal_new_role" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kk_modal_new_role_form" class="form" enctype="multipart/form-data">
...
@push('script')
    <script type="text/javascript">
        ...
        function addNew(){
            ...
            $('.with-errors').text('')
            $('#kk_modal_new_role_form')[0].reset();
            $('#kk_modal_new_role').modal('show');
        }
        ...
        $('#kk_modal_new_service_cancel').on('click', function(){
            $('#kk_modal_new_role_form')[0].reset();
            $("#kk_modal_new_role").modal('hide');
        })

        //new category save
        $('#kk_modal_new_role_form').on('submit',function(e){
            e.preventDefault()
            $('.with-errors').text('')
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.success ==  false || data.success ==  "false"){
                        ...
                        $('#kk_modal_new_role_form').find('.messages').html(alertBox).show();
                    }else{
                        // empty the form
                        $('#kk_modal_new_role_form')[0].reset();
                        $("#kk_modal_new_role").modal('hide');

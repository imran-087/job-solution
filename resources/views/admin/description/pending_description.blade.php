        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Pending Descriptio list</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kk-product-table-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search description">
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#dataTable').DataTable({
                ...
                responsive: true,
                serverSide: true,
                ajax: "{{ url('admin/description/pending-question-description') }}",
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        function view(id){
            $.ajax({
                type:"GET",
                url: "{{ url('admin/description/question-description/show')}}"+'/'+id,
                dataType: 'json',
        ...
        function changeStatus(id){
            Swal.fire({
                ...
                if(o.value){ //if agree
                    $.ajax({
                        type: "GET",
                        url: "{{ url('admin/description/pending-question-description/status') }}"+'/'+id,
                        data: {},
                        success: function (res)
                        {
                            if(res.success){

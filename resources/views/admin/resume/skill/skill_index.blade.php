    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Skill</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Skill Management</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Skill List</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kk-product-table-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search skill">
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                        ...
                        <!--begin::Add product-->
                        <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()"> <i class="fas fa-plus"></i> Add Skill</a>
                        <!--end::Add product-->
                    </div>
...
<div class="modal fade" id="kk_modal_new_skill" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kk_modal_new_skill_form" class="form" enctype="multipart/form-data">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Create or Update Skill</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                                ...
                                <option value="special_skill" >Special Skill</option>
...
@push('script')
    <script type="text/javascript">
        ...
        function addNew(){
            ...
            $('#kk_modal_new_skill_form')[0].reset();
            $('#kk_modal_new_skill').modal('show');
        }
        ...
        $('#kk_modal_new_service_cancel').on('click', function(){
            ...
            $('#kk_modal_new_service_submit').removeAttr('disabled');
            $('#kk_modal_new_skill_form')[0].reset();
            $("#kk_modal_new_skill").modal('hide');
        })

        //new category save
        $('#kk_modal_new_skill_form').on('submit',function(e){
            e.preventDefault()
            $('.with-errors').text('');
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.success ==  false || data.success ==  "false"){
                        ...
                        $('#kk_modal_new_skill_form').find('.messages').html(alertBox).show();
                    }else{
                        // empty the form
                        $('#kk_modal_new_skill_form')[0].reset();
                        $("#kk_modal_new_skill").modal('hide');

            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                        ...
                        <!--begin::Add product-->
                        <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()"> <i class="fas fa-plus"></i> Add Major Subject</a>
                        <!--end::Add product-->
                    </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-150px">Major Subject Name</th>
...
<div class="modal fade" id="kk_modal_new_major_sub" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kk_modal_new_major_sub_form" class="form" enctype="multipart/form-data">
                    <div class="messages"></div>
                    {{-- csrf token  --}}
                    @csrf
                    <input type="hidden" name="major_sub_id">

                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Create or Update Major Subject</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Major Subject Name</span>
                        </label>
                        <!--end::Label-->
...
@push('script')
    <script type="text/javascript">
        ...
        // add new
        function addNew(){
            $('input[name="major_sub_id"]').val('');
            $('.with-errors').text('');
            $('.indicator-label').show();
            $('.indicator-progress').hide();
            $('#kk_modal_new_service_submit').removeAttr('disabled');
            $('#kk_modal_new_major_sub_form')[0].reset();
            $('#kk_modal_new_major_sub').modal('show');
        }
        ...
        function edit(id){
            $.ajax({
                ...
                success:function(data){
                   $('input[name="major_sub_id"]').val(data.id);
        ...
        $('#kk_modal_new_service_cancel').on('click', function(){
            ...
            $('#kk_modal_new_service_submit').removeAttr('disabled');
            $('#kk_modal_new_major_sub_form')[0].reset();
            $("#kk_modal_new_major_sub").modal('hide');
        })

        //new category save
        $('#kk_modal_new_major_sub_form').on('submit',function(e){
            e.preventDefault()
            $('.with-errors').text('');
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.success ==  false || data.success ==  "false"){
                        ...
                        $('#kk_modal_new_major_sub_form').find('.messages').html(alertBox).show();
                    }else{
                        // empty the form
                        $('#kk_modal_new_major_sub_form')[0].reset();
                        $("#kk_modal_new_major_sub").modal('hide');

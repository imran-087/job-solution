    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Passage</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Passage list</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class=" min-w-300px">Passage</th>
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kk_modal_new_passage_form" class="form" enctype="multipart/form-data">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Add New Passage</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Passage Title</span>
                        </label>
                        <!--end::Label-->
    ...
    function deletePassage(id){
        Swal.fire({
            ...
            if(o.value){ //if agree
                $.ajax({
                    type: "GET",
                    url: "{{ url('admin/passage/delete') }}"+'/'+id,
                    data: {},

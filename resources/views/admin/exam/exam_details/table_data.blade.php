                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted">
                                <th>#</th>
                                <th class="min-w-500px">Questions</th>
                                ...
                                <th class="min-w-100px">Option 5</th>
                            </tr>
                        </thead>
                        <!--end::Table head-->
                        <!--begin::Table body-->
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span>{{ $question->question_option->option_1 }}</span>
                                </td>
                                <td>
                                    <span>{{ $question->question_option->option_2 }}</span>
                                </td>
                                <td>
                                    <span>{{ $question->question_option->option_3 }}</span>
                                </td>
                                @isset($question->question_option->option_4)
                                <td>
                                    <span>{{ $question->question_option->option_4 }}</span>
                                </td>
                                @endisset
                                @isset($question->question_option->option_5)
                                <td>
                                    <span>{{ $question->question_option->option_5 }}</span>
                                </td>
                                @endisset
                            </tr>
                            @endforeach
...
<div class="card card-xl-stretch mt-5 mb-xl-8">
    <!--begin::Body-->
    <div class="card-body py-3">
        ...
        <div class="card card-xl-stretch ">
            ...
            <div class="card-header border-0 ">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Passage Question</span>
                    {{-- <span class="text-muted mt-1 fw-bold fs-7">Over {{$questions->count()}} Question</span> --}}
                </h3>
            </div>
            <div class="card-body py-3">
                @foreach($passages as $passage)
                <p class="fs-8"> <span class="fw-bolder text-muted fs-8"></span>Passage : {!! $passage->passage !!}</p>
                <!--begin::Table container-->
                <div class="table-responsive">
                    <!--begin::Table-->
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">

        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
            ...
            <div data-kt-menu-trigger="click" class="menu-item {{ request()->is('admin/samprotik-question*') ? 'show menu-accordion' : '' }}">
                ...
                <div class="menu-sub menu-sub-accordion  menu-active-bg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('admin/question/samprotik-question/create*') ? 'active' : '' }}" href="{{ route('admin.samprotik.index') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Add Question</span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('admin/question/samprotik-question/show*') ? 'active' : '' }}" href="{{ route('admin.samprotik.show') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>

                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kk-product-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search description">
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                        ...
                        <!--begin::Add product-->
                        <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()">Add User</a>
                        <!--end::Add product-->
                    </div>
...
<div class="modal fade" id="kk_modal_new_user" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kk_modal_new_user_form" class="form" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="password" class="form-control form-control-solid" placeholder="Enter Password"
                            name="password" />
                        <div class="help-block with-errors password-error"></div>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <div class="help-block with-errors password_confirmation-error"></div>
                    </div>
                    <!--end::Input group-->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#dataTable').DataTable({
            ...
            responsive: true,
            serverSide: true,
            ajax: "{{ url('admin/user-management/backend-user-list') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
        ...
        function addNew(){
            ...
            $('.with-errors').text('')
            $('#kk_modal_new_user_form')[0].reset();
            $('#kk_modal_new_user').modal('show')
        }

        //cancel button
        $('#kk_modal_new_service_cancel').on('click', function(){
            $('#kk_modal_new_user_form')[0].reset();
            $("#kk_modal_new_user").modal('hide');
        })

        //new category save
        $('#kk_modal_new_user_form').on('submit',function(e){
            e.preventDefault()
            $('.with-errors').text('')
            ...
            $.ajax({
                type:"POST",
                url: "{{ url('admin/user-management/backend-user/store')}}",
                data:formData,
                cache:false,
                contentType: false,
                processData: false,
                success:function(data){
                    if(data.success ==  false || data.success ==  "false"){
                        ...
                        $('#kk_modal_new_user_form').find('.messages').html(alertBox).show();
    ...
    function changeStatus(id) {
        Swal.fire({
            ...
            if (o.value) { //if agree
                $.ajax({
                    type: "GET",
                    url: "{{ url('admin/user-management/backend-user/change-status') }}" + '/' + id,
                    data: {},
                ...
                Swal.fire({
                    text: "Status has not been changed",
                    icon: "error",
                    buttonsStyling: !1,
                    confirmButtonText: "Ok, got it!",
                    customClass: {

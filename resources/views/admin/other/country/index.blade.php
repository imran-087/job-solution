                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-150px">Nationality</th>
                                        <th class="min-w-150px">Capital</th>
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            <div class="d-flex flex-column fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter capital"
                                    name="capital" />
                                <div class="help-block with-errors capital-error"></div>
                            </div>
                        </div>
                        <!--end::Col-->
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="d-flex flex-column fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Enter currency"
                                    name="currency" />
                                <div class="help-block with-errors currency-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            <div class="d-flex flex-column fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter currency name"
                                    name="currency_name" />
                                <div class="help-block with-errors currency_name-error"></div>
                            </div>
                        </div>
                        <!--end::Col-->
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="d-flex flex-column fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter currency symbol"
                                    name="currency_symbol" />
                                <div class="help-block with-errors currency_symbol-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            <div class="d-flex flex-column fv-row">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    <span class="required">Top level domain</span>
                                </label>
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter tld"
                                    name="tld" />
                                <div class="help-block with-errors tld-error"></div>
                            </div>
                        </div>
                        <!--end::Col-->
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="d-flex flex-column fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter native"
                                    name="native" />
                                <div class="help-block with-errors native-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            <div class="d-flex flex-column fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter region"
                                    name="region" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="d-flex flex-column fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter sub region"
                                    name="sub_region" />
                                <div class="help-block with-errors sub_region-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            <div class="d-flex flex-column fv-row">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    <span class="required">Timezones</span>
                                </label>
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter timezones"
                                    name="timezones" />
                                <div class="help-block with-errors timezones-error"></div>
                            </div>
                        </div>
                        <!--end::Col-->
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="d-flex flex-column fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter translations"
                                    name="translations" />
                                <div class="help-block with-errors translations-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            <div class="d-flex flex-column fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter emoji"
                                    name="emoji" />
                                <div class="help-block with-errors emoji-error"></div>
                            </div>
                        </div>
                        <!--end::Col-->
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="d-flex flex-column fv-row">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    <span class="">emojiU</span>
                                </label>
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter emojiU"
                                    name="emojiU" />
                                <div class="help-block with-errors emojiU-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Col-->
...
@push('script')
    <script type="text/javascript">
        ...
        function edit(id){
            $.ajax({
                type:"GET",
                url: "{{ url('admin/country/get')}}"+'/'+id,
                dataType: 'json',
                success:function(data){
                   $('input[name="country_id"]').val(data.id);
                   $('input[name="name"]').val(data.name);
                   $('input[name="nationality"]').val(data.nationality);
                   $('input[name="iso2"]').val(data.iso2);
                   $('input[name="iso3"]').val(data.iso3);
                   $('input[name="numeric_code"]').val(data.numeric_code);
                   ...
                   $('input[name="tld"]').val(data.tld);
                   $('input[name="native"]').val(data.native);
                   $('input[name="region"]').val(data.region);
                   $('input[name="sub_region"]').val(data.sub_region);
                   $('input[name="timezones"]').val(data.timezones);
                   $('input[name="translations"]').val(data.translations);
                   $('input[name="lattitude"]').val(data.lattitude);
                   $('input[name="longitude"]').val(data.longitude);
                   $('input[name="emoji"]').val(data.emoji);
                   $('input[name="emojiU"]').val(data.emojiU);
                   $("#kk_modal_new_country").modal('show');
                }
          });
        }

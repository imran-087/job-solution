    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> City</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">City  Management</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kk-product-table-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search city">
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                        ...
                        <!--begin::Add product-->
                        <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()"> <i class="fas fa-plus"></i> Add City</a>
                        <!--end::Add product-->
                    </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-90px">Country Name</th>
                                        <th class="min-w-90px">State Name</th>
                                        <th class="min-w-90px">Wiki data id</th>
                                        <th class="min-w-90px">lattitude</th>
                                        <th class="min-w-90px">Longitude</th>
...
<div class="modal fade" id="kk_modal_new_city" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kk_modal_new_city_form" class="form" enctype="multipart/form-data">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Create or Update City</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <div class="help-block with-errors country_id-error"></div>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                                data-placeholder="Select state" name="state_id">
                                @foreach($states as $state)
                                <option value="{{ $state->id }}">{{$state->name}}</option>
                                
                                @endforeach
                            </select>
                            <div class="help-block with-errors state_id-error"></div>
                        </div>
                        <!--end::Col-->
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="d-flex flex-column fv-row">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    <span class="">Wiki data id</span>
                                </label>
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter wiki_data_id"
                                    name="wiki_data_id" />
                                <div class="help-block with-errors wiki_data_id-error"></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Col-->
...
@push('script')
    <script type="text/javascript">
        ...
        function addNew(){
            ...
            $('#kk_modal_new_city_form')[0].reset();
            $('#kk_modal_new_city').modal('show');
        }
        ...
        function edit(id){
            $.ajax({
                type:"GET",
                url: "{{ url('admin/city/get')}}"+'/'+id,
                dataType: 'json',
                success:function(data){
                   $('input[name="city_id"]').val(data.id);
                   $('select[name="country_id"]').val(data.country_id).change();
                   $('select[name="state_id"]').val(data.state_id).change();
                   $('input[name="wiki_data_id"]').val(data.wiki_data_id);
        ...
        $('#kk_modal_new_service_cancel').on('click', function(){
            ...
            $('#kk_modal_new_service_submit').removeAttr('disabled');
            $('#kk_modal_new_city_form')[0].reset();
            $("#kk_modal_new_city").modal('hide');
        })

        //new category save
        $('#kk_modal_new_city_form').on('submit',function(e){
            e.preventDefault()
            $('.with-errors').text('');
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.success ==  false || data.success ==  "false"){
                        ...
                        $('#kk_modal_new_city_form').find('.messages').html(alertBox).show();
                    }else{
                        // empty the form
                        $('#kk_modal_new_city_form')[0].reset();
                        $("#kk_modal_new_city").modal('hide');

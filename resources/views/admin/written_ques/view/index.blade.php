                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="timeline-label mb-5">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <!--begin::Text-->
                                    <div class="fw-bolder timeline-content cursor-pointer ps-3 border p-3 rounded getsubCategory data-on-load" data-id="{{ $category->id }}" data-main_cat="{{ $category->main_category_id }}">

                            ...
                            <div class="mb-0">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-center collapsible py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_10_1_{{ $without_parent_question->id }}">
                                        ...
                                        <!--end::Icon-->
                                        <!--begin::Title-->
                                        <h4 class="text-gray-700 fw-bolder cursor-pointer mb-0">{{ $without_parent_question->question_no }} &nbsp; {{ $without_parent_question->question }}</h4>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Heading-->
                                    <!--begin::Body-->
                                    <div id="kt_job_10_1_{{ $without_parent_question->id }}" class="collapse show fs-6 ms-1">
                                        <!--begin::Text-->

                ...
                <div class="card card-bordered mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="font-size: 16px">
                            ...
                            <div class="col-md-6">
                                <p class="text-gray-800 fw-normal mb-5"> <b>&#9398</b> {{$question->question_option->option_1 }}</p>
                            </div>
                            @endif
                            @if(isset($question->question_option->option_2))
                            <div class="col-md-6">
                                <p class="text-gray-800 fw-normal mb-5"> <b>&#9399</b> {{$question->question_option->option_2 }}</p>
                            </div>
                            @endif
                            @if(isset($question->question_option->option_3))
                            <div class="col-md-6">
                                <p class="text-gray-800 fw-normal mb-5"> <b>&#9400</b> {{$question->question_option->option_3}}</p>
                            </div>
                            @endif
                            @if(isset($question->question_option->option_4 ))
                            <div class="col-md-6">
                                <p class="text-gray-800 fw-normal mb-5"> <b>&#9401</b> {{$question->question_option->option_4}}</p>
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex align-items-center  collapsible py-3 toggle mb-0 collapsed" data-bs-toggle="collapse" data-bs-target="#kt_job_4_1_{{$question->id}}" aria-expanded="false">
                                ...
                                <div class="float-right">
                                     <a href="javascript:;" class="bookmark me-2 btn btn-sm btn-light btn-color-muted btn-active-light-primary px-4 py-2"  data-id="{{ $question->id }}" title="bookmark">

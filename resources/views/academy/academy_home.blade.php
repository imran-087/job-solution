...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Academy Home</h1>
            <!--end::Title-->
            <!--begin::Separator-->
                        ...
                        <div class="card-body p-lg-20">
                            ...
                            <div class="text-center mb-5 mb-lg-10">
                                ...
                                <h3 class="fs-2hx text-dark mb-5" id="explore"
                                    data-kt-scroll-offset="{default: 100, lg: 150}">Academy</h3>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Tabs wrapper-->
                                        ...
                                        <ul class="nav nav-tabs flex-center flex-nowrap text-nowrap mb-2 fw-bolder fs-5">
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 active" href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_hsc">HSC</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 " href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_ssc">SSC</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 " href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_class_8">Class 8</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 " href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_class_7">Class 7</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 " href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_class_6">Class 6</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 " href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_class_5">Class 5</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 " href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_class_4">Class 4</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 " href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_class_3">Class 3</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 " href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_class_2">Class 2</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 " href="#"
                                                    data-bs-toggle="tab" data-bs-target="#kt_landing_projects_class_1">Class 1</a>
                                            </li>
                            ...
                            <div class="tab-content">
                                <!--begin::Tab pane-->
                                <div class="tab-pane show active" id="kt_landing_projects_hsc">
                                    <!--begin::Row-->
                                                ...
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Commerce</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <!--end::Tab pane-->
                                <!--begin::Tab pane-->
                                <div class="tab-pane fade" id="kt_landing_projects_ssc">
                                    <!--begin::Row-->
                                    <div class="row g-10 d-flex justify-content-center">
                                         @for($i=0; $i<3; $i++)
                                        <!--begin::Col-->
                                            ...
                                            <a href="" class="">
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Science</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <!--end::Tab pane-->
                                <!--begin::Tab pane-->
                                <div class="tab-pane fade" id="kt_landing_projects_class_8">
                                    <!--begin::Row-->
                                    <div class="row g-10 d-flex justify-content-center">
                                         @for($i=0; $i<6; $i++)
                                        <!--begin::Col-->
                                            ...
                                            <a href="" class="">
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Class 8</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <!--end::Tab pane-->
                                <!--begin::Tab pane-->
                                <div class="tab-pane fade" id="kt_landing_projects_class_7">
                                    <!--begin::Row-->
                                    <div class="row g-10 d-flex justify-content-center">
                                         @for($i=0; $i<8; $i++)
                                        <!--begin::Col-->
                                            ...
                                            <a href="" class="">
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Class 7</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <!--end::Tab pane-->
                                <!--begin::Tab pane-->
                                <div class="tab-pane fade" id="kt_landing_projects_class_6">
                                    <!--begin::Row-->
                                    <div class="row g-10 d-flex justify-content-center">
                                         @for($i=0; $i<5; $i++)
                                        <!--begin::Col-->
                                            ...
                                            <a href="" class="">
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Class 6</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <!--end::Tab pane-->
                                <!--begin::Tab pane-->
                                <div class="tab-pane fade" id="kt_landing_projects_class_5">
                                    <!--begin::Row-->
                                    <div class="row g-10 d-flex justify-content-center">
                                         @for($i=0; $i<5; $i++)
                                        <!--begin::Col-->
                                            ...
                                            <a href="" class="">
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Class 5</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <!--end::Tab pane-->
                                <!--begin::Tab pane-->
                                <div class="tab-pane fade" id="kt_landing_projects_class_4">
                                    <!--begin::Row-->
                                    <div class="row g-10 d-flex justify-content-center">
                                         @for($i=0; $i<5; $i++)
                                        <!--begin::Col-->
                                            ...
                                            <a href="" class="">
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Class 4</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <!--end::Tab pane-->
                                <!--begin::Tab pane-->
                                <div class="tab-pane fade" id="kt_landing_projects_class_3">
                                    <!--begin::Row-->
                                    <div class="row g-10 d-flex justify-content-center">
                                         @for($i=0; $i<5; $i++)
                                        <!--begin::Col-->
                                            ...
                                            <a href="" class="">
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Class 3</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <!--end::Tab pane-->
                                <!--begin::Tab pane-->
                                <div class="tab-pane fade" id="kt_landing_projects_class_2">
                                    <!--begin::Row-->
                                    <div class="row g-10 d-flex justify-content-center">
                                         @for($i=0; $i<5; $i++)
                                        <!--begin::Col-->
                                            ...
                                            <a href="" class="">
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Class 2</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <!--end::Tab pane-->
                                <!--begin::Tab pane-->
                                <div class="tab-pane fade" id="kt_landing_projects_class_1">
                                    <!--begin::Row-->
                                    <div class="row g-10 d-flex justify-content-center">
                                         @for($i=0; $i<5; $i++)
                                        <!--begin::Col-->
                                            ...
                                            <a href="" class="">
                                                <div class="d-flex align-items-center rounded">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('academy.class') }}" class="fw-bolder  text-black mb-1 fs-4">Class 1</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>

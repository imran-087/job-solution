...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Academy Class</h1>
            <!--end::Title-->
            <!--begin::Separator-->
    ...
    <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="card card-flush h-xl-100 ">
                        ...
                        <div class="card-header pt-7 mb-9">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-gray-800 fs-2">Class Seven</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Header-->
                                        ...
                                        <div class="d-flex align-items-center rounded">
                                            <div class="d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="text-center">
                                                    <a href="{{ route('academy.subject') }}" class="fw-bolder text-white mb-1 fs-4">Bangla </a>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
        ...
        <div class="question-bank">
            ...
            <div class="row g-5 g-xl-10 mb-5 mb-xl-10 ">							
                ...
                <div class="col-md-12">
                    <!--begin::Tables widget 13-->
                    <div class="card card-flush h-xl-100" style="background-color: #3DC77D">
                        <!--begin::Header-->
                        <div class="card-header pt-7 mb-md-9 ">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-white fs-2">Question Bank</span>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-10 d-flex justify-content-around px-5 px-md-0">
                                <!--begin::Col-->
                                <div class="card bg-light card-rounded col-md-3 py-7 m-3">
                                    <a href="" class="">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <div class="text-center">
                                                <a href="" class="fw-bolder  text-success mb-1 fs-4">Question</a>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="card bg-light card-rounded col-md-3 py-7 m-3">
                                    <a href="" class="">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <div class="text-center">
                                                <a href="" class="fw-bolder  text-success mb-1 fs-4">Forum</a>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="card bg-light card-rounded col-md-3 py-7 m-3">
                                    <a href="" class="">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <div class="text-center">
                                                <a href="" class="fw-bolder  text-success mb-1 fs-4">Board Question</a>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <div id="kt_sliders_widget_2_slider" class="card card-flush carousel carousel-custom carousel-stretch slide h-xl-100" data-bs-ride="carousel" data-bs-interval="5500">
                                        ...
                                        <div class="card-header py-7">
                                            ...
                                            <h4 class="card-title d-flex align-items-start flex-column">
                                                <span class="card-label fw-bold text-gray-800">Bcs</span>
                                        ...
                                        <ul class="nav nav-tabs flex-center flex-nowrap text-nowrap mb-2 fw-bolder fs-5">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="#"
                                                    ><img src="{{ asset('assets') }}/media/stock/600x400/img-2.jpg" class="card-rounded h-100px" alt=""/></a>
                                            </li>
                                            @endfor
                                        </ul>
                                    </div>

                ...
                <div class="card card-bordered mb-5">
                    <div class="card-header">
                        <h3 class="card-title text-gray-700 fw-bolder cursor-pointer mb-0" style="max-width: 600px !important;">
                           <a href="{{ route('question.single-question', ['ques_id' => $bookmark->question_id]) }}"> {{ $key+1 }}. {{$bookmark->samprotik_ques->question}}</a>
                         ...
                         <div class="row"  style="font-size: 16px">
                            ...
                            <div class="col-md-6">
                                <p class="text-gray-800 fw-normal mb-5 "> 
                                    <i class="fas fa-check fa-2xl" ></i> {{$bookmark->samprotik_ques->answer}}</p>
                            </div>
                          
                        </div>
                        <div class="d-flex justify-content-start mt-2">
                            <button type="button" class="btn btn-sm  btn-light me-3">
                                 <a href="#">@if($bookmark->category == 'bn') Bangladesh @elseif($bookmark->category == 'in') International @else Bangladesh & International @endif</a>
                            </button>              
                    ...
                    <div class="card-footer" style="padding-top:0px !important; padding-bottom:0px !important;">
                        <div class="d-flex justify-content-end mt-2" style="margin-bottom: -40px !important;">
                                ...
                                <a href="" style="cursor:default" class="btn btn-sm btn-light btn-color-muted btn-active-light-success px-4 py-2 me-4">
                                    <i class="fas fa-eye fa-xl"></i> {{$bookmark->samprotik_ques->view_count}}
                                </a>
                                ...
                                <!--end::Svg Icon-->{{$bookmark->samprotik_ques->vote}}</a>
                        </div>
                        <!--begin::Accordion-->
                        <!--begin::Section-->
                        <div class="m-0">
                            ...
                            <!--begin::Heading-->
                            <div class="d-flex align-items-center  collapsible py-3 toggle mb-0 collapsed" data-bs-toggle="collapse" data-bs-target="#kt_job_4_1_{{$bookmark->id}}" aria-expanded="false">
                                <!--begin::Icon-->
                                ...
                                {{-- <p class="badge badge-circle badge-success">{{ $bookmark->descriptions->count() }}</p> --}}
                                <!--end::Title-->
                            ...
                            <!--end::Heading-->
                            <!--begin::Body-->
                            <div id="kt_job_4_1_{{$bookmark->id}}" class="fs-6 ms-1 collapse" style="">
                                @foreach($bookmark->samprotik_ques->descriptions as $description)

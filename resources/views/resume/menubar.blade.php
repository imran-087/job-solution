<div class="card mb-9 text-center">
    <div class="card-body text-center">
        ...
        <a href="{{ route('resume.view.index') }}" class="btn btn-light btn-active-color-primary me-3 py-3 fs-6 fw-bolder  {{  Request::routeIs('resume.view.index') ? 'active' : '' }}"><i class="fas fa-eye fa-2xl"></i>View Resume</a>
    </div>
</div>
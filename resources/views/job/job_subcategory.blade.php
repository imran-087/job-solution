...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Job - {{ Str::ucfirst($category->name) }}</h1>
            <!--end::Title-->
            <!--begin::Separator-->
                    ...
                    <div class="card card-flush h-xl-100 ">
                        ...
                        <div class="card-header pt-7 mb-9">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-gray-800 fs-2">All - {{ Str::ucfirst($category->name) }} </span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Header-->

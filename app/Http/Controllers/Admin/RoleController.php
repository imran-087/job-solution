...
class RoleController extends Controller
{
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $btn = '<div class="d-flex justify-content-start flex-shrink-0">
                        ...
                        <a href="javascript:;" onclick="deleteRole(' . $row->id . ')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (isset($request->role_id) &&  $role = Role::find($request->role_id)) { //update
                //dd($request->role_id);

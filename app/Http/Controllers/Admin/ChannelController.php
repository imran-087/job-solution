...
class ChannelController extends Controller
{
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $btn = '<div class="d-flex justify-content-start flex-shrink-0">
                        ...
                        <a href="javascript:;" onclick="deleteChannel(' . $row->id . ')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (isset($request->channel_id) && $channel = Channel::find($request->channel_id)) { //update
                //dd($request->channel_id);

...
class ExamResultController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = ExamResultAnalytic::orderBy('created_at', 'desc')->select();
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    <div class="d-flex justify-content-start flex-shrink-0">
                        ...
                        <a href="exam-result-details-view?exam_result_id=' . $row->exam_result_id . '" class="btn btn-sm btn-primary">
                            view
                        </a>
                    </div>';
                    return $btn;
                ...
                ->rawColumns(['action', 'exam_id', 'user_id', 'status'])
                ->make(true);
        }
    ...
    public function show(Request $request)
    {
        ...
        return view('admin.exam.exam_result.exam_details_view', compact('exam_result_collection', 'exam_analytics'));
    }
}
